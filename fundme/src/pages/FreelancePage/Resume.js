...
function Resume({ profile }) {
  return (
    <div className="flex flex-col justify-center w-full bg-slate-800 min-h-screen xl:pl-36 xl:pr-36 lg:pl-28 lg:pr-28 md:pl-20 md:pr-20 sm:pl-12 sm:pr-12 pl-6 pr-6">
      <h2 className="text-5xl text-center text-blue-400">My Skills</h2>
