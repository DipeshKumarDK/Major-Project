...
function About({profile}) {
  return (
    <div className="flex flex-col justify-center w-full bg-slate-800 min-h-screen xl:pl-36 xl:pr-36 lg:pl-28 lg:pr-28 md:pl-20 md:pr-20 sm:pl-12 sm:pr-12 pl-6 pr-6 pt-20 pb-20">
    <div className="text-center lg:text-6xl md:text-5xl sm:text-4xl text-3xl text-blue-400">
