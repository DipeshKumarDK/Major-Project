...
function Experience({profile}) {
  return (
    <div className='w-full bg-slate-800 xl:pl-24 xl:pr-24 lg:pl-16 lg:pr-16 md:pl-10 md:pr-10 sm:pl-6 sm:pr-6 pl-3 pr-3 pt-24 h-screen overflow-y-scroll no-scrollbar'>
        <h2 className='md:text-5xl sm:text-4xl text-3xl text-blue-400'>Experience</h2>
