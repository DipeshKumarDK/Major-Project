...
import FreeProfileCard from '../../components/FreeProfileCard'
...
function Talent() {
  ...
  return (
    <div ref={ref} className='pt-14 pb-14'>
        ...
        <motion.div animate={animation} className='text-4xl text-center text-white'>Meet Talented Freelancers On Our Platform</motion.div>
        </div>
