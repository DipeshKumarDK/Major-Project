...
const UpdateResumeCom = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col xl:pl-32 lg:pl-24 md:pl-16 sm:pl-12 pl-4 xl:pr-32 lg:pr-24 md:pr-16 sm:pr-12 pr-4 md:pt-10 pt-5 md:pb-10 pb-7 text-white">
      {isLoading && <Loader/>}
      <div className="flex flex-row w-full mt-4 justify-center">
        <motion.div ref={ref} animate={animation} className="sm:text-3xl text-2xl font-semibold cursor-pointer text-blue-100">
          UPDATE YOUR PROFILE
        </motion.div>
      </div>
      <motion.div animate={animation} className="flex flex-row w-full mb-6 justify-center">
        <h3 className="mt-2 text-slate-300 text-center font-semibold">
      ...
      >
        ...
        <div className="w-full sm:flex hidden justify-start items-center p-4 pl-6 bg-gradient-to-r from-[#1f2637] to-[#1b2132] h-[120px] rounded-[10px]">
          <img
            src={pic}
            alt="money"
