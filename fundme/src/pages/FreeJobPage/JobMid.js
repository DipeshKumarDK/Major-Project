...
const [isLoading, setIsLoading] = useState(false);
  ...
  return (
    <div className="">
      {isLoading && <Loader/>}
      <h2 className="pt-10 pb-10 2xl:pl-40 2xl:pr-40 xl:pl-40 xl:pr-40 lg:pl-24 lg:pr-24 md:pl-16 md:pr-16 sm:pl-10 sm:pr-10 pl-6 pr-6 text-3xl text-white bg-blue-900">
        {job?.title}
      </h2>
      <div className="flex md:flex-row flex-col 2xl:pl-40 2xl:pr-40 xl:pl-40 xl:pr-40 lg:pl-24 lg:pr-24 md:pl-16 md:pr-16 sm:pl-10 sm:pr-10 pl-6 pr-6 pt-6 pb-6 bg-slate-800">
        <div className="bg-slate-700 md:w-2/3 w-full pt-6 pb-6 pl-4 pr-4">
          <h3 className="text-xl">Job Description</h3>
          <p className="text-slate-200 mt-3">{job?.description}</p>
          ...
          <p className="text-slate-200 mt-3">{job?.com_desc}</p>
        </div>
        <div className="md:pl-4 md:pr-4 md:w-1/3 w-full md:mt-0 mt-4 text-black">
          <div className="bg-slate-700 shadow-md p-4">
            <h3 className="text-lg text-white">Make A Bid</h3>
            <input
              ref={_cost}
          ...
          <div className="bg-slate-700 shadow-md p-4 mt-4 text-white">
            <h3 className="text-lg">Amount Offered</h3>
            <h4 className="text-slate-200 mt-2">{job?.expected_cost} MATIC</h4>
          </div>
          <div className="bg-slate-700 shadow-md p-4 mt-4 text-white">
            <h3 className="text-lg">Expected Time</h3>
            <h4 className="text-slate-200 mt-2">{job?.expected_time} Days</h4>
          </div>
          <div className="bg-slate-700 shadow-md p-4 mt-4 text-white">
            ...
            <div className="mt-2 text-slate-200">Email: {job?.email}</div>
          </div>
          <div className="bg-slate-700 shadow-md p-4 mt-4 text-white">
            <h3 className="text-lg">Company's Address</h3>
            <h4 className="text-slate-200 mt-2">{job?.com_address}</h4>
          </div>
        </div>
      </div>

      <div className="2xl:pl-40 2xl:pr-40 xl:pl-40 xl:pr-40 lg:pl-24 lg:pr-24 md:pl-16 md:pr-16 sm:pl-10 sm:pr-10 pl-6 pr-6 pt-6 pb-6 bg-slate-800">
        <h2 className="text-3xl mb-3">Look Who Made A Bid</h2>
        <div className="h-96 overflow-y-scroll no-scrollbar border-[4px] border-gray-600 bg-slate-700 p-2">
