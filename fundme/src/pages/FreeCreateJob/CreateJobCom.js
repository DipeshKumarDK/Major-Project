...
const CreateJobCom = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col xl:pl-32 lg:pl-24 md:pl-16 sm:pl-12 pl-4 xl:pr-32 lg:pr-24 md:pr-16 sm:pr-12 pr-4 md:pt-8 pt-5 md:pb-10 pb-7 text-white">
      {isLoading && <Loader/>}
      <motion.div ref={ref} animate={animation} className="flex flex-row w-full mt-4 justify-center">
        <h2 className="sm:text-3xl text-2xl font-semibold cursor-pointer text-blue-100">
          CREATE YOUR JOB
        </h2>
      </motion.div>
      <motion.div animate={animation} className="flex flex-row w-full mb-6 justify-center">
        <h4 className="mt-2 text-slate-300 font-semibold">
