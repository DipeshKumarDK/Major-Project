...
function AllFreeMid() {
  ...
  const myCategory = useSelector((state) => state.changeFreeCategory);
  ...
  return (
    <div className="xl:pl-28 xl:pr-28 min-h-screen lg:pl-16 lg:pr-16 md:pl-16 md:pr-16 sm:pl-10 sm:pr-10 pl-6 pr-6 pt-12 pb-8 text-white">
      <motion.div
        animate={animation}
        ref={ref}
        className="md:text-4xl sm:text-3xl text-2xl text-center text-blue-100"
      >
