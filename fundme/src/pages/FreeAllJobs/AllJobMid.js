...
function AllJobMid() {
  ...
  return (
    <div className="xl:pl-32 xl:pr-32 lg:pl-24 lg:pr-24 md:pl-16 md:pr-16 sm:pl-10 sm:pr-10 pl-6 pr-6 pt-12 pb-8 min-h-screen text-white">
      <motion.div ref={ref} animate={animation} className="md:text-4xl sm:text-3xl text-2xl text-center text-blue-100">
