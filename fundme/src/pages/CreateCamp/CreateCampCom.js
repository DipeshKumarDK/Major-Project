...
const CreateCampCom = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const campaignData = await contract.createProject(
      [form.owner_name,  form.video, form.tagline, form.title, form.description, form.image, form.country, form.ho_address, form.plan, form.twitter, form.mail,form.instagram, form.linkedIn, form.doc],
