...
function BidCard({bidArray, owner , desc, image, _id}) { 
  ...
  return (
    <div to="/freelancer" className="bg-slate-800 mt-2 mb-2 p-3 cursor-pointer border-[2px] border-slate-600 rounded flex sm:flex-row flex-col">
      ...
      <div className="lg:w-2/6 w-1/3 sm:flex flex-col hidden justify-center">
        <h2 className="text-lg text-slate-300 text-center">Amount: {ethers.utils.formatEther(bidArray[0].toString())*1000000000000000000}</h2>
        <h2 className="text-lg text-slate-300 text-center mt-1">Time: {ethers.utils.formatEther(bidArray[1].toString())*1000000000000000000} Days</h2>
        <h2 className="text-lg text-slate-300 text-center mt-1">{ethers.utils.formatEther(bidArray[2].toString())*1000000000000000000} ⭐ out of 5</h2>
