...
function FreeProfileCard({title, desc, pId, image}) {
  ...
  return (
    <div className="ml-3 mr-3 shadow-lg md:mt-0 mt-3">
      <img className="w-full h-64" src={pic1||image} alt="" />
      <div className="pl-3 pr-3 pt-2 pb-4 bg-slate-800">
      <h2 className="text-lg mt-2 text-blue-200">{title}</h2>
...
export default FreeProfileCard;
