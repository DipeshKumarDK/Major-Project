    ...
    <div className="sticky top-0 z-50">
      ...
      >
        ...
        <div className={`md:w-3/4 w-full flex flex-row justify-end ${props?.hide === "yes"?"hidden":""}`}>
          ...
          <div>
            <div onClick={navigateToFreelance} className="text-white bg-gradient-to-r from-[#567081] to-[#50c4e7] cursor-pointer pt-2 pb-2 mt-0.5 sm:text-base text-sm pl-3 pr-3 rounded">
              Freelance
            </div>
          </div>
